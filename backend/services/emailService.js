...
//     doc.image(qrPath, 257.5, doc.y + 10, { width: 80 });
//     doc.moveDown(7);
...
const generateInvoicePDF = (doc, paymentData) => {
    ...
    doc.image(qrPath, 50, qrSectionY, { width: 100 });

    // App Content Text next to QR Code
    doc.fillColor('#111111').fontSize(10).font('Helvetica-Bold').text('Fitistan-Community Fitness App', 160, qrSectionY + 15);
    doc.fontSize(8.5).font('Helvetica-Bold').text('About this app:', 160, qrSectionY + 30);
    doc.fontSize(8.5).font('Helvetica').text('Track your steps, conquer exciting challenges, and achieve your fitness goals!', 160, qrSectionY + 42, { width: 350 });
    doc.fontSize(8).font('Helvetica-Bold').fillColor('#008080').text('Scan QR code to download Fitistan-Community Fitness App', 160, qrSectionY + 65);

    // Move cursor below the QR section for final footer
    doc.y = qrSectionY + 110;
